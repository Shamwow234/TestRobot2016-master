...
//All of the Talons are added here and can be used with other commands or subsystems.
...
void RobotMap::init() {
    ...
    driveBaseSubRobotDrive->SetInvertedMotor(driveBaseSubRobotDrive->kFrontRightMotor, true);
    driveBaseSubRobotDrive->SetInvertedMotor(driveBaseSubRobotDrive->kRearRightMotor, true);

    shooterSubsystemShooterTalon.reset(new CANTalon(3));
